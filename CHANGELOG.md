...
### Added
- `qtclass/learn/index.md`：实训学习业务方向档案（真实工作即课堂、学习方式、成长进度条、代金券制度、参与通道）

### Removed
- 删除已迁移或过时的 qtclass 数据（courses.json、zstu-big-data、quotation）
- 删除空档案：`qtdata/datasets.json`、`qtcloud/resources.json`（内容均为空 `records`）
